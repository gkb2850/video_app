...
/* 14 */
/*!*****************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/video_app/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*****************************************************************************************/
...
/* 15 */
/*!**********************************************************************!*\
  !*** C:/Users/Administrator/Desktop/video_app/pages/index/index.vue ***!
  \**********************************************************************/
/*! no static exports found */
...
/* 16 */
/*!*****************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/video_app/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*****************************************************************************************************/
...
try {
  components = {
    navBar: function() {
      return __webpack_require__.e(/*! import() | components/navBar/navBar */ "components/navBar/navBar").then(__webpack_require__.bind(null, /*! @/components/navBar/navBar.vue */ 105))
    }
  }
} catch (e) {
  if (
...
/* 18 */
/*!***********************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/video_app/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 19 */
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/Administrator/Desktop/video_app/pages/index/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var navBar = function navBar() {__webpack_require__.e(/*! require.ensure | components/navBar/navBar */ "components/navBar/navBar").then((function () {return resolve(__webpack_require__(/*! @/components/navBar/navBar.vue */ 105));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var filmImgBox = function filmImgBox() {__webpack_require__.e(/*! require.ensure | components/filmImgBox/index */ "components/filmImgBox/index").then((function () {return resolve(__webpack_require__(/*! @/components/filmImgBox/index.vue */ 112));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...

{
  ...
  methods: {
    getBannerList: function getBannerList() {var _this = this;
      ...
      this.$ajax.getIndexBannerFeach(obj).then(function (res) {
        var arr = [];
        if (res.data && res.data.length) {
          res.data.some(function (i, oi) {
            arr.push(i);
            return oi > 8;
          });
        }
        _this.bannerDataList = arr;
      }).catch(function (err) {
        _this.$message.error(err.msg);
      });
    },
    getClassifyList: function getClassifyList() {var _this2 = this;
      this.$ajax.getIndexClassifyFeach().then(function (res) {
        _this2.classifyDatasList = res.data;
        _this2.getVideoList();
      }).catch(function (err) {
        console.log(err);
    ...
    selectClassifyIndex: function selectClassifyIndex(num) {
      this.classifyIndex = num;
      this.getBannerList();
      this.getVideoList();
    },
    getVideoList: function getVideoList() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var obj, _yield$_this3$$ajax$g, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                obj = {
                  typeId: _this3.classifyDatasList[_this3.classifyIndex].id,
                  limit: 6 };_context.next = 3;return (

                  _this3.$ajax.getIndexVideoFeach(obj));case 3:_yield$_this3$$ajax$g = _context.sent;data = _yield$_this3$$ajax$g.data;
                console.log(data.list);
                _this3.videoDataList = data.list;case 7:case "end":return _context.stop();}}}, _callee);}))();
    },
    toSeeMoreVideo: function toSeeMoreVideo(row) {
      console.log(row);
      uni.navigateTo({
...
/* 23 */
/*!********************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/video_app/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
